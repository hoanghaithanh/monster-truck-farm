...
| 14 | As a player, I want to spend the coins I've earned to buy an upgrade in one of the four builder categories, so my truck actually gets stronger over time | M | [truck-builder-and-upgrades.md](requirements/truck-builder-and-upgrades.md) | Sprint 2 — issue [#22](https://github.com/hoanghaithanh/monster-truck-farm/issues/22); architecture: [0006-coin-spend-and-tier-unlock.md](architecture/0006-coin-spend-and-tier-unlock.md) |
| 15 | As a player, I want the farmer to chase me for ~10 seconds at 1/3 my speed and then give up ("tired") if he doesn't catch me, so encounters feel fair and skippable | M | [farmer-minimal-bump.md](requirements/farmer-minimal-bump.md) | Sprint 2 — issue [#23](https://github.com/hoanghaithanh/monster-truck-farm/issues/23); architecture: [0007-farmer-full-chase-timer-and-dynamic-speed.md](architecture/0007-farmer-full-chase-timer-and-dynamic-speed.md) |
...
| 17 | As a player, I want fuel pickups to spawn on the map that refill my gas tank when I drive over them, so I have an active, exploration-based alternative to idling for gas regen | M | [fuel-pickups.md](requirements/fuel-pickups.md) | Sprint 2 — issue [#24](https://github.com/hoanghaithanh/monster-truck-farm/issues/24); architecture: [0008-fuel-pickups.md](architecture/0008-fuel-pickups.md) |
